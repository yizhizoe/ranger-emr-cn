...
curl -iv -u admin:admin -d @ranger-hdfs-policy-all.json -H "Content-Type: application/json" -X PUT http://$ranger_server_fqdn:6080/service/public/api/policy/1 || true
